  ...
  function edit_cat(id)
    {
        $('#i_edit_id').val(id );
         showUILoader('<img src="'+base_url+'images/loading_big.gif" width="50"/> ');
             ...
             $.ajax({
                 type: "post",
                 url: base_url+'admin/trade_center/product_categories/edit_info/'+id,
                 dataType:"json",
...
function delete_()
  ...
  if( selected_id!=0 )
  {
       $.ajax({
                 type: "post",
                 url:base_url + 'admin/trade_center/product_categories/delete_information',
                 dataType:"json",
                data: ({'id':selected_id}),
                 success: function(json_response){
                     hide_dialog();
                      if(json_response.result = 'success') {
                        ...
                        showUIMsg("Product Category has been deleted successfully.");
...
function delete_sub_cat_()
  ...
  if( selected_id!=0 )
  {
       $.ajax({
                 type: "post",
                 url:base_url + 'admin/trade_center/product_categories/delete_sub_information',
                 dataType:"json",
                data: ({'id':selected_id}),
                 success: function(json_response){
                     hide_dialog();
...
$(document).ready(function(arg) {
    ...
    optionsArr = { 
        ...
        url:        admin_base_url + "trade_center/product_categories/add_info"
    }; 
    ...
    optionsArr_edit = { 
        ...
        url:        admin_base_url + "trade_center/product_categories/edit_info"
    }; 
    ...
    // for AJAX page-submission... add ------------- sub cat-----------------------------
     subCat_optionsArr = { 
        ...
        url:        admin_base_url + "trade_center/product_categories/add_sub_cat_info"
    }; 
    ...
    subCat_optionsArr_edit = { 
        ...
        url:        admin_base_url + "trade_center/product_categories/edit_sub_cat_info"
    }; 
 //------------------------------------- sub cat end -----------------------------
