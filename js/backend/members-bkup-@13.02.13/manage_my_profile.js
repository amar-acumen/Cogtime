...
function validateFrm(data)
{
	...
	if(result_obj.result=='success') {
		...
		$('#member_personal_info_details').html( base64_decode(result_obj.content) );	// loading display-part...
		$('#frmManageProfile').html( base64_decode(result_obj.form_content) );	  // loading the form-part...
		
		//// SHOW FORM [BEGIN]
		frm_obj2 = $('#frmManageProfile');
		$(frm_obj2).find('.form-table').hide(); 
        if($(frm_obj2).parents('.sec-detail').find('.text-table').css('display')=='none'){
            $(frm_obj2).parents('.sec-detail').find('.text-table').show();
        }
		//// SHOW FORM [END]
	}
...
function validateBasicFrm(data)
{
	...
	if(result_obj.result=='success') {
		...
		$('#member_basic_info_details').html( base64_decode(result_obj.content) );	// loading display-part...
		$('#frmManageBasicProfile').html( base64_decode(result_obj.form_content) );	  // loading the form-part...
...
function validateEduFrm(data)
{
	...
	if(result_obj.result=='success') {
		...
		showUIMsg(result_obj.msg);
		//window.location.href = result_obj.redirect;
		$('#member_edu_details').html( base64_decode(result_obj.content) );	// loading display-part...
		$('#frmManageEduProfile').html( base64_decode(result_obj.form_content) );	  // loading the form-part...
...
function validateWorkFrm(data)
{
	...
	if(result_obj.result=='success') {
		...
		//closeDiv('4');
		//window.location.href = result_obj.redirect;
		$('#member_work_details').html( base64_decode(result_obj.content) );	// loading display-part...
		$('#frmManageWorkProfile').html( base64_decode(result_obj.form_content) );	  // loading the form-part...
...
function validateSkillFrm(data)
{
	...
	if(result_obj.result=='success') {
		...
		showUIMsg(result_obj.msg);
		//window.location.href = result_obj.redirect;
		$('#member_skill_details').html( base64_decode(result_obj.content) );	// loading display-part...
		$('#frmManageSkillProfile').html( base64_decode(result_obj.form_content) );	  // loading the form-part...
