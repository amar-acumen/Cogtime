...
function validateFrm(data)
{
	...
	if(result_obj.result=='success') {
		...
		$('#member_personal_info_details').html(result_obj.content);	// loading display-part...
		$('#frmManageProfile').html(result_obj.form_content);	  // loading the form-part...
        ...
        if($(frm_obj2).parents('.sec-detail').find('.text-table').css('display')=='none'){
            ...
            $(frm_obj2).parents('.sec-detail').find('.dd').hide();
        }
		//// SHOW FORM [END]
	}
...
function validateBasicFrm(data)
{
	...
	if(result_obj.result=='success') {
		...
		$('#member_basic_info_details').html(result_obj.content);	// loading display-part...
		$('#frmManageBasicProfile').html(result_obj.form_content);	  // loading the form-part...
...
function validateEduFrm(data)
{
	...
	if(result_obj.result=='success') {
		...
		showUIMsg(result_obj.msg);
		//window.location.href = result_obj.redirect;
		$('#member_edu_details').html(result_obj.content);	// loading display-part...
		$('#frmManageEduProfile').html(result_obj.form_content);	  // loading the form-part...
...
function validateWorkFrm(data)
{
	...
	if(result_obj.result=='success') {
		...
		//closeDiv('4');
		//window.location.href = result_obj.redirect;
		$('#member_work_details').html(result_obj.content);	// loading display-part...
		$('#frmManageWorkProfile').html(result_obj.form_content);	  // loading the form-part...
...
function validateSkillFrm(data)
{
	...
	if(result_obj.result=='success') {
		...
		showUIMsg(result_obj.msg);
		//window.location.href = result_obj.redirect;
		$('#member_skill_details').html(result_obj.content);	// loading display-part...
		$('#frmManageSkillProfile').html(result_obj.form_content);	  // loading the form-part...
