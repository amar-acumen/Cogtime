  ...
  function edit_cat(id)
    {
        $('#i_edit_id').val(id );
         showUILoader('<img src="'+base_url+'images/loading_big.gif" width="50"/> ');
             ...
             $.ajax({
                 type: "post",
                 url: base_url+'admin/trade_center/product_attributes/edit_info/'+id,
                 dataType:"json",
                 ...
                 success: function(json_response){
                      ...
                      if(json_response.result = 'success') {
                          ...
                          $('#txt_edit_cat_name').val(json_response.s_name);
						  $('#sel_edit_cat').val(json_response.i_type);
						  $('#trade_cat').html(json_response.html);
...
function delete_()
  ...
  if( selected_id!=0 )
  {
       $.ajax({
                 type: "post",
                 url:base_url + 'admin/trade_center/product_attributes/delete_information',
                 dataType:"json",
                data: ({'id':selected_id}),
                 success: function(json_response){
                     hide_dialog();
                      if(json_response.result = 'success') {
                        ...
                        showUIMsg("Product Attribute has been deleted successfully.");
...
function delete_sub_cat_()
  ...
  if( selected_id!=0 )
  {
       $.ajax({
                 type: "post",
                 url:base_url + 'admin/trade_center/product_attributes/delete_sub_information',
                 dataType:"json",
                data: ({'id':selected_id}),
                 success: function(json_response){
                     hide_dialog();
                      if(json_response.result = 'success') {
                        //$('#row_'+selected_id).hide();
                        $('#table_content').html(base64_decode(json_response.response));
                        showUIMsg("Product Sub-Category has been deleted successfully.");
...
$(document).ready(function(arg) {
    ...
    optionsArr = { 
        ...
        url:        admin_base_url + "trade_center/product_attributes/add_info"
    }; 
    ...
    optionsArr_edit = { 
        ...
        url:        admin_base_url + "trade_center/product_attributes/edit_info"
    }; 
    ...
    // for AJAX page-submission... add ------------- sub cat-----------------------------
     subCat_optionsArr = { 
        ...
        url:        admin_base_url + "trade_center/product_attributes/add_sub_cat_info"
    }; 
    ...
    subCat_optionsArr_edit = { 
        ...
        url:        admin_base_url + "trade_center/product_attributes/edit_sub_cat_info"
    }; 
 //------------------------------------- sub cat end -----------------------------
