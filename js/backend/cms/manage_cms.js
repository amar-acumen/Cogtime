function displayOrderAJAX(recordId, status)
{
	...
	var URL = admin_base_url + 'site_settings/cms_pages/maintain_displayorder_ajax/';
...
function delete_()
{
	...
	if( selected_id!=0 )
	{
		...
		var delURL = admin_base_url + 'site_settings/cms_pages/delete_information/'+ selected_id;
