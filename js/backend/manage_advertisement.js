...
function displayOrderAJAX(recordId, status)
{
	...
	var URL = admin_base_url +'site_settings/advertisement/maintain_displayorder_ajax/'+ selected_language;
...
function delete_confirm_(file_id)
	...
	if( selected_id!=0 )
	{
		showUIMsg("The selected advertisement has been deleted successfully.");
		var delURL = admin_base_url + 'site_settings/advertisement/delete_information/'+ selected_id;
