...
var tb_pathToImage = "images/loading_big.gif";
//alert(location.host);
...
function tb_show(caption, url, imageGroup) {//function called when the user clicks on a thickbox link
	...
	try { 
		...
		$("body").append("<div id='TB_load'><img src='"+imgLoader.src+"' width='"+imgLoader.width+"'  height='"+imgLoader.height+"' /></div>");//add loader to the page
