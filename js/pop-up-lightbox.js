...
(function($) {
    ...
    // alert(1);
			var outerImage = '<div id="outerImageContainer" style="min-width:465px;"><div id="imageContainer"><iframe id="lightboxIframe"></iframe><img id="lightboxImage" /><div id="hoverNav" ><a href="javascript://" title="' + opts.strings.prevLinkTitle + '" id="prevLink"></a><a href="javascript://" id="nextLink" title="' + opts.strings.nextLinkTitle + '"></a></div><div id="loading"><a href="javascript://" id="loadingLink"><img src="'+opts.fileLoadingImage+'"></a></div></div></div>';
			var imageData = '<div id="imageDataContainer" class="clearfix" style="min-width:465px;"><div id="imageData"><div id="imageDetails"><span id="caption"></span><span id="numberDisplay"></span></div><div id="bottomNav">';
		...
		*/
		...
		function doChangeImage() {
			...
			imgPreloader.onload = function() {
				//alert(imgPreloader.height+' pre size'+imgPreloader.width);
				...
				if (opts.fitToScreen) {
					...
					var ratio;//alert(arrayPageSize);alert(opts.borderSize);
				...
				$('#lightboxImage').
					...
					width(newWidth).
					height(newHeight);
					//alert(newWidth+' new dim '+newHeight);
			...
			function resizeImageContainer(imgWidth, imgHeight) { //alert(imgWidth+' -- --'+imgHeight);
			...
			function updateDetails() {
				...
				if (opts.imageArray.length > 1) {
					...
					if (opts.displayDownloadLink) {
						//nav_html += "<a href='" + opts.imageArray[opts.activeImage][0] + "' target='_blank'>" + opts.strings.download + "</a>";
					}				

					if (!opts.disableNavbarLinks) {
						// display previous / next text links
						if ((opts.activeImage) > 0 || opts.loopImages) {
							nav_html = '<a title="' + opts.strings.prevLinkTitle + '" href="#" id="prevLinkText">' + opts.strings.prevLinkTitle + "</a>" + nav_html;
						}

						if (((opts.activeImage + 1) < opts.imageArray.length) || opts.loopImages) {
							nav_html += '<a title="' + opts.strings.nextLinkTitle + '" href="#" id="nextLinkText">' + opts.strings.nextLinkTitle + "</a>";
						}
					}
		...
		$.fn.lightbox.defaults = {
			...
			strings: {
				...
				nextLinkTitle: 'Next',
				prevLinkText:  '&laquo; Pr&eacute;c&eacute;dent',
