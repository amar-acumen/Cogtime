			 ...
			 $.ajax({
				 ...
				 success: function(json_response){
					  ...
					  if(json_response.result = 'success') {
							...
							$('#edit_todo_strt_frm').val(json_response.note_arr.t_start_time);
							$('#edit_todo_end_frm').val(json_response.note_arr.t_end_time);
							$('#edit_todo_rem_time').val(json_response.note_arr.t_remind_time);
							$('#hd_edit_tododate').val(json_response.note_arr.d_date);
...
function edit_list_ajax() 
{
		...
		ajax_list_post = $.ajax({
			...
			data: {'ta_edit_todo_desc': $('#ta_edit_todo_desc').val(),
					...
					'i_list_id' : id, 
					'hd_edit_tododate': $('#hd_edit_tododate').val()},
			type: 'post',
