...
function edit_prayer_partner_(user_id, i)
{
    //alert(desc);
    ...
    // alert(i);
    //alert($('#text_area_edit_prayer_point_'+i).val());
    var des = $('#text_area_edit_prayer_point_' + i).val();
    var prev_desc = $('.prev_desc_' + i).val();
    var row_id = $('.row_id_' + i).val();
    //alert(row_id);
//    //alert(des +'  '+id);
    showUILoader_nodialog('<img src="' + base_url + 'images/loading_big.gif" width="50"/> ');
    $.ajax({
        type: "post",
        url: base_url + "logged/my_prayer_partners/edit_prayer_partner",
        dataType: "json",
        data: ({'frnd_id': id, 'des': des, 'prev_desc': prev_desc, 'row_id': row_id}),
        success: function(data)
        {
