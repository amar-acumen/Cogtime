...
function show_comments(i_ring_id)
{
	 ...
	 showUILoader_nodialog('<img src="'+base_url+'images/loading_big.gif" width="50"/> ');
		$.ajax({
			...
			url: base_url +'logged/ring_home/NEW_fetch_comment_ring/'+i_ring_id,
			dataType: 'json',
			type: 'post',
  ...
  function show_people_liked(i_ring_id)
  {
	  showUILoader_nodialog('<img src="'+base_url+'images/loading_big.gif" width="50"/> ');
		$.ajax({
			...
			url: base_url +'logged/ring_home/new_fetch_likes_on_ring/'+i_ring_id,
			dataType: 'json',
			type: 'post',
...
function post_comment(id) 
{
		...
		ajax_comment_post = $.ajax({
			...
			url: base_url+'logged/ring_home/post_comment/'+ id,
			dataType: 'json',
...
showUILoader_nodialog('<img src="'+base_url+'images/loading_big.gif" width="50"/> ');
	$.ajax({
		type: "POST",
		url: base_url+"logged/ring_home/like_unlike",
...
{ 
		...
		ajax_comment_post = $.ajax({
			...
			url: base_url+'logged/ring_home/post_on_ring/'+ id,
			dataType: 'json',
