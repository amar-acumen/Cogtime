...
<?php foreach ($this->contacts_classes as $k => $v) {?>
	<?php /*?><li><a href="<?php echo "{$this->base_url}contacts_option=$k"; ?>"><?php echo $v->ClassName . ($v->ExternalAuth ? "<br/>(External Authentication)" : ""); ?></a></li><?php */?>
...
<div class="copy">Copyright &copy; 2006-2010 Svetlozar Petrov | <a href="http://contactsimporter.com/address-book-importer/">PHP Address Book Importer</a></div>
<script type="text/javascript">
	try
	{
