...
.click-button{ 
 ...
 .green{ color: #39af00; font-size: 15px; margin-bottom: 10px; display: block;}
...
';	
		echo "<body onLoad=\"document.forms['paypal_form'].submit();\">\n";
                ...
                echo "<div style='background-color:#013d62; padding:20px 0 20px 0; width:644px; margin:140px auto 0;'><img src='".base_url()."images/logo.png' style='margin:0 auto 0 auto; display:block;' width='230' height='57' alt=''/></div>";
		echo "<div class='as_wrapper'>";
                echo "<h2 style='margin:20px 0 20px 0; padding:0;'>Please wait, your order is being processed and you will be redirected to the paypal website.</h2>";
		...
		echo "<center><br/><br/>You are automatically redirected to ";
		echo "paypal within 5 seconds...<br/><br/>\n";
                echo "<div class='green'>After successful payment at paypal <br>please  click on <strong>'Return to cogtime payment's Store'</strong> to complete your full payment...</div><br>";
		echo "<input class='click-button' type=\"submit\" value=\"Click Here\"></center>\n";
 ...
 */
	...
	public function dump_fields() {
		...
		// add_field() function.
		echo "<h3 style ='display:none;'>paypal_class->dump_fields() Output:</h3>";
		echo "<table width=\"95%\" border=\"1\" cellpadding=\"2\" cellspacing=\"0\" style = 'display:none;' >
            <tr>
