...
class activate_account extends Base_controller {
    ...
    public function __construct() {
        try {
            parent::__construct();
            $this->user_id = $this->uri->segment(2);
    ...
    public function activate_user_account($user_id = '') {
        try {
            ...
            if (count($arr_messages) == 0) {
                ...
                if ($i_ret && $i_ret_stat) {
                    echo json_encode(array('success' => true, 'arr_messages' => $arr_messages, 'msg' => 'Your account has been activated.Please login'));
                }
            } else {
