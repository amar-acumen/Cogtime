                                      ...
                                      if($this->input->post('chkRem')=='1'  || $this->input->post('chkRem')== 'true' || $this->input->post('chkRem')== 'checked') 
                                        {
                                            ...
                                            setcookie("CG_FO[password]", $this->input->post('password', true), time()+2592000, "/"); 											setcookie("CG_FO[remember]", 'checked', time()+2592000, "/"); 
      ...
      /// the same authentication function for admin login-authentication...
	    ...
	    public function set_as_profile_pic($id) {
		    ...
		    if( !is_array($photo_details) || !count($photo_details) 
				    || @$photo_details['s_photo']=='' || $photo_details['i_user_id'] != $user_id ) {
