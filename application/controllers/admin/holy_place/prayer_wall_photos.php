...
class Prayer_wall_photos extends Admin_base_Controller
{
        ...
        try
        {
         ...
         //// Page
            ...
            if( !is_numeric($URI_SEGMENT) ) {
                $this->session->unset_userdata('current_page_prayer_wall_photos');
                $this->session->unset_userdata('search_prayer_wall_photos');
    ...
    function show_all()
    {
        ...
        ob_start();
        $this->prayer_wall_photos_ajax_pagination();
        $html = ob_get_contents();
        ob_end_clean();
    ...
    function add_prayer_wall_photos()
    {
        ...
        try
        {
            ...
            if($_POST)
            {
                ...
                $re_page = admin_base_url() ."holy-place/prayer-wall-photos.html";
                header("location:".$re_page);
                exit;
