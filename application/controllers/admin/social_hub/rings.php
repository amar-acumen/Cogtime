    ...
    public function change_status() {
        ...
        if ($this->session->userdata('user_id') != "") {
            ...
            if ($i_status == 1) {
                ...
                $action_txt = '<input name="" title="ENABLE" type="button" class="btn-06" onclick="javascript:changeStatus(\'' . $ID . '\',\'2\',\'' . $i_status . '\')"  value="DISABLE"/>';
            } else if ($i_status == 2) {
                $action_txt = '<input name="" title="DISABLE" type="button" class="btn-06" onclick="javascript:changeStatus(\'' . $ID . '\',\'1\',\'' . $i_status . '\')"  value="ENABLE"/>';
            }
        } else {
