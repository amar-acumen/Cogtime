...
class Media_article extends Admin_base_Controller
{
...
//echo "current page : ".$current_page.'--';
            ...
            $VIEW_FILE = "admin/media_center/media_article.phtml";
    ...
    //echo "total : ".$total_rows;exit;
            ...
            $config['base_url'] = base_url()."admin/media_center/media_article/christian_news_listing_ajax";
