...
class Edit_christian_news_category extends Admin_base_Controller
{
    ...
    public function index($current_page,$news_id) 
    {
        ...
        try
        {
            ...
            $data['news_info'] = $this->landing_page_cms_model->fetch_news_cat_by_id($news_id);
           
            
            
            # rendering the view file...
            $VIEW_FILE = "admin/media_center/edit_christian_news_category.phtml";
    ...
    function post_edit_data()
    {
        ...
        $key=array();
            ...
            $info['s_cat_name'] = get_formatted_string($this->input->post('s_cat_name'));
            
            if($info['s_cat_name']=='')
            {
                $arr_messages['s_cat_name']='* Required field';
            ...
            {
//pr($info,1);
				$this->landing_page_cms_model->update_news_cat_by_id($info,$news_id);
            ...
            $result = 'success';
            $msg = 'News category updated successfully.';
