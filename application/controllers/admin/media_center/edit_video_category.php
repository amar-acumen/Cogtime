...
class Edit_video_category extends Admin_base_Controller
{
    ...
    public function index($current_page,$news_id) 
    {
        ...
        try
        {
            ...
            $data['news_info'] = $this->landing_page_cms_model->fetch_video_cat_by_id($news_id);
           
            
            
            # rendering the view file...
            $VIEW_FILE = "admin/media_center/edit_video_category.phtml";
    ...
    function post_edit_data()
    {
        ...
        $key=array();
            ...
            {
//pr($info,1);
				$this->landing_page_cms_model->update_video_cat_by_id($info,$news_id);
