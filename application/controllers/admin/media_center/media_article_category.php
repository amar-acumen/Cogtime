...
class Media_article_category extends Admin_base_Controller
{
    ...
    public function index($page = 0) 
    {
        ...
        try
        {
            ...
            ### ajax call ###
            ob_start();
            $this->christian_news_category_listing_ajax($current_page);
...
//echo "current page : ".$current_page.'--';
            ...
            $VIEW_FILE = "admin/media_center/media_article_category.phtml";
    ...
    public function christian_news_category_listing_ajax($page=0)
    {
         try
         {
             //echo $page;
            ...
            $result = $this->landing_page_cms_model->get_all_news_cat($s_where ,$page,$this->news_pagination_per_page,$order_by);
            // echo 'res :'.count($result);                                                   
            
            $resultCount = count($result);
            $total_rows = $this->landing_page_cms_model->get_total_news_cat($s_where); 
            if(count($result)==0 && $total_rows)
            {
                $page= $page - $this->news_pagination_per_page;
                $result = $this->landing_page_cms_model->get_all_news_cat($s_where ,$page,
    ...
    //echo "total : ".$total_rows;exit;
            ...
            $config['base_url'] = base_url()."admin/media_center/media_article_category/christian_news_category_listing_ajax";
            ...
            # rendering the view file...
            $VIEW_FILE = "admin/media_center/media_article_category_ajax.phtml";
