...
class Product_categories extends Admin_base_Controller
{
    ...
    public function index() 
    {
        ...
        try
        {
            ...
            $VIEW_FILE = "admin/trade_center/product_categories/product_categories.phtml";
    ...
    public function product_category_ajax_pagination($page=0)
    {
        try
        {
		 ...
		 $WHERE_COND = '';
			...
			$order_by = "p.s_category_name ASC ";
		   	$result = $this->product_categories_model->get_list($s_where,$page,$this->product_category_pagination_per_page,$order_by);
            $resultCount = count($result);
			#echo $this->db->last_query(); exit;
			$total_rows = $this->product_categories_model->get_list_count($s_where);
            ...
            $config['base_url'] = base_url()."admin/trade_center/product_categories/product_category_ajax_pagination";
          ...
          echo  $this->load->view('admin/trade_center/product_categories/product_categories_ajax.phtml', $data,TRUE);
		 }
        catch(Exception $err_obj)
        {
            show_error($err_obj->getMessage());
