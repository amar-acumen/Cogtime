...
$this->db->update('cg_church', $data); 
    ...
    $query_churchmember = $this->db->query($sql_churchmember);
     ...
     function find_member_church_by_email(){
        ...
        $query =  $this->db->query('Select * from cg_church where s_name like "%'.$txt_name_church.'%" AND s_address like "%'.$txt_address_church.'%" or s_postcode like "%'.$txt_postcode_church.'%" ');
