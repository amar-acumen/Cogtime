            ...
            if (count($arr_messages) == 0) {
                ...
                if ($is_temp_pwd_fld == 2) {
                    ...
                    if (!empty($loggedin)) {
                        ...
                        echo json_encode(array('success' => 'false', 'msg' => 'Error in connection!1', 'arr_messages' => $arr_messages));

                        exit;
                    }
                }
            } else {
                echo json_encode(array('success' => 'false', 'msg' => t('Error in connection!2'), 'arr_messages' => $arr_messages));
                exit;
            }
        } catch (Exception $err_obj) {
            show_error($err_obj->getMessage());
