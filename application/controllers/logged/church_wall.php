	...
	public function post_comment($feed_id) {
        ...
        if ($message != '') {
			...
			$com_html='<div id="comment_content_div"'.$cid.'"><div class="txt_content01 comments-number-content"> 
					 			<a href="javascript:void(0);"><div class="pro_photo" style="background:url('.get_profile_image('thumb',$arr['s_profile_photo'],$arr['e_gender']).') no-repeat center;width:48px; height:48px;"></div></a>
