...
class My_profile extends Base_controller {
    ...
    public function modify_my_profile_personal_info_ajax() {
        ...
        if ($this->input->post('is_submitted', true) != "") {
            ...
            /*             * ***************1-12-2014 uploaded image******************* */
                     $file_name = $_FILES['txt_profile_pic']['name'];
            ...
            /***************uploaded image*****1-12-2014************************/
             $this->form_validation->set_rules('txt_profile_pic', "Profile Photo", 'trim|required');
            /****************************************/
            ...
            else  if((date("Y")-$posted["year"]) < 18){
                $arr_messages['dob'] = "your age should be 18+ ";
            }
            /* if($posted["month"] == ''){
            ...
            /*****************file type validation ***12-1-2014**************************/
            if($_FILES['txt_profile_pic']['name'] != '' && ($extension != 'gif' && $extension != 'jpeg' && $extension != 'jpg' && $extension != 'png' && $extension != 'GIF' && $extension != 'JPEG' && $extension != 'JPG' && $extension != 'PNG')){
               
               
             // echo $extension;
               
                  
                   $arr_messages['profile_pic'] = "Please upload valid image(gif,jpeg,jpg,png)"; 
...
$chat_name=get_chat_name_by_id($i_profile_id);
...
$this->db->where('id', $id);
$this->db->update('cg_users', $data); 
	echo json_encode(array( "msg"=>"Delete successfuly",
									"success"=>true));
		exit;
        //echo $id;
       // die('ok');
