...
class change_password extends Base_controller {
    ...
    public function index() {
        try {
            ...
            # view file...
            $VIEW = "logged/change_password.phtml";
    ...
    public function update_info() {
        try {
            ...
            if (count($arr_messages) == 0) {
                ...
                if (is_temp_password_user($i_user_id) == 1) {
                    update_temp_pwd_fld($i_user_id);
                }

                if ($i_ret) {
                    echo json_encode(array('success' => true, 'arr_messages' => $arr_messages, 'msg' => 'Password updated Successfully.'));
                }
            } else {
