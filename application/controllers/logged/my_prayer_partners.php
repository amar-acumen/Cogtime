    ...
    public function ajax_pagination($page = 0) {
        try {
            ...
            if (isset($_POST['search_basic']) && $_POST['search_basic'] == 'Y') {
                ...
                $sql_churchmember = "SELECT member_id AS members FROM cg_church_member WHERE church_id IN
                ...
                $query = "SELECT member_id AS members FROM cg_church_member WHERE church_id IN
