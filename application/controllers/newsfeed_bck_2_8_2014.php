		...
		if(1) 
		 {
			...
			if($message!='' || !empty($imagevalue) || $this->input->post('txt_video_url')!='')
		    {
			 ...
			 else
			   {
				  ...
				  echo json_encode( array('success'=>FALSE, 'msg'=>"Please enter some text!", 'vid_msg'=>$video_url_messages) );																		                  exit;
			   }
		}
		else {
		  
			echo json_encode( array('success'=>FALSE, 'msg'=>'Error!', 'vid_msg'=>''));exit;
		}
