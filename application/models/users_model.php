...
#echo nl2br($sql); #exit;
    ...
    function fetch_church_member($user_id){
        $SQL = "SELECT c.s_name as member_church_name , cm.church_id as member_church_id ,cm.created_date as member_join_date ,cm.is_blocked as member_block_status FROM cg_church_member  cm, cg_church c  WHERE cm.member_id='" . $user_id . "' AND c.id = cm.church_id "; 
