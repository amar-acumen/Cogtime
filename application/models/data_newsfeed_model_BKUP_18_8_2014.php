...
{$sql="select distinct c.* from cg_users u ,cg_user_newsfeeds c ".$s_where." and c.i_owner_id='".$i_user_id."'and u.i_isdeleted='1'  limit ".$i_start_limit.",".$i_no_of_page;}
#echo $sql;
$query=$this->db->query($sql);
$result_arr=$query->result_array();
//echo $sql;exit;
...
{
$sql="select count(distinct c.id) as count from cg_users u ,cg_user_newsfeeds c ".$s_where." and c.i_owner_id='".$i_user_id."'and u.i_isdeleted='1' ";
#echo $sql;
$query=$this->db->query($sql);
$result_arr=$query->result_array();
return $result_arr['0']['count'];
