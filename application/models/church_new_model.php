...
class Church_new_model extends Base_model
{
	...
	public function __construct() 
	{
    	...
    	function get_churchmembers($c_id,$where='',$i_start=0,$order_by=' cm.id DESC',$i_limit=0){
            ...
            LEFT JOIN cg_users AS u ON cm.member_id=u.id WHERE cm.church_id = '.$c_id.' AND cm.is_deleted=0 AND cm.is_blocked=1 AND cm.is_approved = 1 '.$where.' '.$order_by.' '.$limit.'';
				//echo $sql;
