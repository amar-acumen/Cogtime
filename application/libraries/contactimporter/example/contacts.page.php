    ...
    <body>
        <div class="content">
            <div class="page_heading">
                <div class="left" id="headingDiv"><img src="images/icons/<?php echo ( $_REQUEST['contacts_option'] == 'Yahoo' || $_REQUEST['contacts_option'] == '') ? 'yahoo-icon.png' : 'gmail-icon.png' ?>" alt="" /> <?php echo ( $_REQUEST['contacts_option'] == 'Yahoo' || $_REQUEST['contacts_option'] == '') ? 'Yahoo' : 'Gmail' ?> Contacts Importer</div>
            </div>
            <div class="mail-request-padding">
                <ul class="mail-request">
                    <li> <a href="<?php echo base_url()?>find-friends/Yahoo">Yahoo</a></li>
                    <li><a href="<?php echo base_url()?>find-friends/Gmail">Gmail</a></li>
                </ul>
                <br class="clear"/>
...
<!--                    <h1>Address Book<br />
                        Importer Demo</h1>
                    <h3 class="center">
                        <?php // echo isset($this->current_class) ? "{$this->current_class->ClassName} Contacts Importer" : ""; ?>
                    </h3>-->
           ...
           <?php /*?> <div class="lable02">&nbsp;</div>
            <div class="field01">
                <textarea id="mailids" class="mailids"></textarea>
            </div><?php */?>
        ...
        <script type="text/javascript">
            ...
            (function() {
				...
				$('#ToggleSelectedAll').click(function () {    
            ...
            function showInTextarea()
            {
               ...
               var datatosend = "frnds_mailid="+mail_ids;
				$.ajax({
					type: "POST",
