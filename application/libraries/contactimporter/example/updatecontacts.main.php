<?php
include_once(APPPATH.'libraries/contactimporter/Svetlozar.NET/init.php');
...
class ContactsHandler
{
	...
	public static $contacts_page 	= "updatecontacts.page.php";		//!< the page that will be diplayed when handle_request is called
