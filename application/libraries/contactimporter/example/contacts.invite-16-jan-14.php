	<form id="invite_form" class="center" method="post">
		<table cellpadding="4px" cellspacing="0" width="100%;">
			...
			<tr style="overflow:hidden">
				<td><input type="checkbox" name="contacts[<?php echo $contact->name; ?>]" value="<?php echo $contact->email; ?>" checked="checked" /></td>
				<td><span class="Names"><?php echo $contact->name; ?></span></td>
				<td><?php echo $contact->email; ?></td>
			</tr><?php } ?>
		</table>
		<button type="button" id="btnContactsForm" value="invite" onclick="showInTextarea();">Do Something (Displays Contacts, No email is sent)</button>
	</form>
