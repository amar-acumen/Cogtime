...
$db['default']['CHAT_ROOM'] = "room";
$db['default']['CHAT_ROOM_INVITATION'] = $dbprefix."prayer_grp_chat_room_invitation"; 
$db['default']['chat_invitation'] = $dbprefix."chat_invitation"; 
## chat tables ##
...
$db['default']['BO_MENU'] = $dbprefix."bo_menu";
$db['default']['ring_grp_chat_room_invitation'] = $dbprefix."ring_grp_chat_room_invitation";
...
### etrade product attributes:
$db['default']['category_attribute'] = $dbprefix."category_attribute";
$db['default']['category_attribute_values'] = $dbprefix."category_attribute_values";
