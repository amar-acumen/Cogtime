...
function chatHeartbeat() {
	...
	$sql = "select * from cg_im_chat where ( cg_im_chat.to = '".mysql_real_escape_string($_SESSION['username'])."'
...
EOD;
	...
	$sql = "update cg_im_chat set recd = 1 where 
									cg_im_chat.to = '".mysql_real_escape_string($_SESSION['username'])."' 
									 AND cg_im_chat.to_id = ".$_SESSION['IMuserid']."
									and recd = 0";
	$query = mysql_query($sql);
...
?>
{
		...
		"items": [
         ...
         "chatuserid" : <?php echo $_SESSION['IMuserid']; ?>
}
