...
$tinybrowser['path']['image'] = '/cogtime/tiny_uploads/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/cogtime/tiny_uploads/media/'; // Media files location
$tinybrowser['path']['file']  = '/cogtime/tiny_uploads/files/'; // Other files location
